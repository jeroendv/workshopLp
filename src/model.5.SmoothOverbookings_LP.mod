...
var OverbookingsThresholdAchieved{w in W, s in S, t in T} >= 0;
...
minimize obj:
	...
	sum{w in W, s in S, t in T}
		OverbookingsThresholdAchieved[w,s,t]*OverbookingCost;
...
_OverBookingsThresholds{w in W, s in S, t in T}:
	OverbookingsThresholdAchieved[w,s,t]>= overbooked[w,s]-OverbookingsThresholds[t];

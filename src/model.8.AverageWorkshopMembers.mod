...
# based on model.4
#
# But by adding a cost to to the difference in members in each session of a 
# workshop will hopefull ensure that the number of members in each session of a 
# workshop is aproximately the same.
